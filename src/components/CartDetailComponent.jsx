  ...
  return (
    <div className={css({
      ...
      <div className={css({
        ...
        alignItems: 'center',
        padding: '20px',
        borderBottom: `1px solid ${isDarkMode ? 'gray.700' : 'gray.200'}`, // Corregido
      })}>
      ...
      <div className={css({
        borderTop: `1px solid ${isDarkMode ? 'gray.700' : 'gray.200'}`, // Corregido
        padding: '20px',
      })}>
        <div className={css({
          display: 'flex',
        ...
        <div className={css({
          display: 'grid',
          gridTemplateColumns: '1fr', // Changed to 1fr to remove "Vaciar Carrito" button
          gap: '10px',
        })}>
          <button
