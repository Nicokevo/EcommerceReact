const tokens = {
  ...
  "colors.background.dark": {
    "value": "#121212",
    "variable": "var(--colors-background-dark)"
  },
  "colors.text": {
    "value": "#1a1a1a",
  ...
  "colors.border.dark": {
    "value": "#2e2e2e",
    "variable": "var(--colors-border-dark)"
  },
  "colors.input": {
    "value": "#ffffff",
  ...
  "colors.input.dark": {
    "value": "#2a2a2a",
    "variable": "var(--colors-input-dark)"
  },
  "colors.hover": {
    "value": "#f5f5f5",
  ...
  "colors.hover.dark": {
    "value": "#2a2a2a",
    "variable": "var(--colors-hover-dark)"
  },
  "breakpoints.sm": {
    "value": "640px",
  ...
  "colors.app-bg": {
    "value": "var(--colors-background--d-e-f-a-u-l-t)",
    "variable": "var(--colors-app-bg)"
  },
  "colors.app-bg._dark": {
    "value": "var(--colors-background-dark)",
    "variable": "var(--colors-app-bg-_dark)"
  },
  "colors.app-text": {
    "value": "var(--colors-text--d-e-f-a-u-l-t)",
    "variable": "var(--colors-app-text)"
  },
  "colors.app-text._dark": {
    "value": "var(--colors-text-dark)",
    "variable": "var(--colors-app-text-_dark)"
  },
  "colors.card-bg": {
    "value": "var(--colors-card--d-e-f-a-u-l-t)",
    "variable": "var(--colors-card-bg)"
  },
  "colors.card-bg._dark": {
    "value": "var(--colors-card-dark)",
    "variable": "var(--colors-card-bg-_dark)"
  },
  "colors.border-color": {
    "value": "var(--colors-border--d-e-f-a-u-l-t)",
    "variable": "var(--colors-border-color)"
  },
  "colors.border-color._dark": {
    "value": "var(--colors-border-dark)",
    "variable": "var(--colors-border-color-_dark)"
  },
  "colors.input-bg": {
    "value": "var(--colors-input--d-e-f-a-u-l-t)",
    "variable": "var(--colors-input-bg)"
  },
  "colors.input-bg._dark": {
    "value": "var(--colors-input-dark)",
    "variable": "var(--colors-input-bg-_dark)"
  },
  "colors.hover-bg": {
    "value": "var(--colors-hover--d-e-f-a-u-l-t)",
    "variable": "var(--colors-hover-bg)"
  },
  "colors.hover-bg._dark": {
    "value": "var(--colors-hover-dark)",
    "variable": "var(--colors-hover-bg-_dark)"
  },
  "spacing.-1": {
  ...
  "colors.colorPalette._dark": {
    "value": "var(--colors-color-palette-_dark)",
    "variable": "var(--colors-color-palette-_dark)"
  }
}
